...
class args():
	...
	dataset_ir = "./21_pairs_tno/images/ir"
	dataset_vi = "./21_pairs_tno/images/vi"
	...
	resume_fusion_model = './models/train/fusionnet/6.0/Final_epoch_2_alpha_700_wir_6.0_wvi_3.0.model'
	# nest net model
	...
	#用于测试时读取的模型根目录，要想读取自己训练的名字路径要保持一致，6.0为w
	#6.0/Final_epoch_2_alpha_700_wir_6.0_wvi_3.0_ssim_vi.model
